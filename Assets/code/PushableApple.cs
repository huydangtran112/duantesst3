...
public class PushableApple : MonoBehaviour
{
    ...
    public bool TryPush(Vector3 pushDirection, WormMovement worm)
    {
        ...
        if (wallHit != null)
        {
            ...
            if (worm != null)
            {
                ...
                worm.TriggerVomitWithTimeout(-pushDirection, 7f);
            }
        ...
        if (hit == null || hit.CompareTag("Apple"))
        {
    ...
    IEnumerator FallRoutine()
    {
        ...
        GameManager.Instance?.Lose("Apple bị rơi khỏi nền");
        Destroy(gameObject);
    }
